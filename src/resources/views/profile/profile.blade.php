    ...
    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-100/50 border border-slate-100 overflow-hidden mb-8">
        ...
        <div class="px-8 pb-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 class="text-3xl font-black tracking-tight">John Doe</h1>
                    <p class="text-slate-500 font-medium">john.doe@example.com</p>
                </div>
                
                <div class="flex gap-4">
                    <div class="px-6 py-3 bg-slate-50 rounded-2xl border border-slate-100 text-center">
                        <span class="block text-xl font-black text-indigo-600">12</span>
                        <span class="text-[10px] uppercase tracking-widest font-bold text-slate-400">Questions</span>
                    </div>
                    <div class="px-6 py-3 bg-slate-50 rounded-2xl border border-slate-100 text-center">
                        <span class="block text-xl font-black text-indigo-600">48</span>
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-slate-700">Janvier 2026</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <span class="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center">📍</span>
                        <div>
                            ...
                            <p class="text-sm font-bold text-slate-700">Paris, France</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="group bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all flex items-center justify-between">
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        <h4 class="font-bold text-slate-900 group-hover:text-indigo-600 transition">Besoin d'un tournevis plat</h4>
                        <p class="text-sm text-slate-400 font-medium">Il y a 2 heures • 3 réponses</p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <button class="p-3 text-slate-400 hover:bg-slate-50 hover:text-indigo-600 rounded-xl transition">✏️</button>
            ...
            <div class="group bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all flex items-center justify-between">
                <div class="flex items-center gap-5">
                    <div class="w-14 h-14 rounded-2xl bg-green-50 flex items-center justify-center text-xl">🌿</div>
                    <div>
                        <h4 class="font-bold text-slate-900 group-hover:text-indigo-600 transition">Aide pour arroser mes plantes</h4>
                        <p class="text-sm text-slate-400 font-medium">Hier • 0 réponse</p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <button class="p-3 text-slate-400 hover:bg-slate-50 hover:text-indigo-600 rounded-xl transition">✏️</button>
